    ...
    def get_technical_analysis(self, pair="EURUSD=X", period="3mo", indicators=None, cache_timeout=1800):
        ...
        try:
            ...
            try:
                ...
                df.ta.ema(length=26, append=True)  # EMA 26
            ...
            technical_data = {
                ...
                'indicators': {
                    ...
                    'ATRr_14': {
                        'value': safe_float(latest.get('ATRr_14'), 6),
                        'signal': 'High' if pd.notna(latest.get('ATRr_14')) and latest.get('ATRr_14', 0) > 0.01 else 'Low',
                        'history': safe_history(df.get('ATRr_14', pd.Series()))
                    }
                },
